    ...
    const ShahiSettings = {
        ...
        validateForm: function(e) {
            ...
            if (email && !this.isValidEmail(email)) {
                e.preventDefault();
                ShahiSettings.showNotice('error', 'Please enter a valid email address.');
        ...
        handleConditionalFields: function() {
            // Show/hide complete cleanup warning
            $('input[name="complete_cleanup"]').on('change', function() {
                const preserveCheckboxes = $(
                    'input[name="preserve_landing_pages"], ' +
                    'input[name="preserve_analytics_data"], ' +
                    'input[name="preserve_settings"], ' +
                    'input[name="preserve_user_capabilities"]'
                );
                
                if ($(this).is(':checked')) {
                    preserveCheckboxes.prop('disabled', true).closest('.shahi-setting-row').css('opacity', '0.5');
                } else {
                    preserveCheckboxes.prop('disabled', false).closest('.shahi-setting-row').css('opacity', '1');
                }
            }).trigger('change');
        },
        ...
        showNotice: function(type, message) {
            ...
            $('.shahi-settings-page .shahi-page-header').after(notice);
