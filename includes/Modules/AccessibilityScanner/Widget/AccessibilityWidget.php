...
class AccessibilityWidget {
    ...
    public function init() {
        ...
        add_action('wp_ajax_slos_track_widget_event', [$this, 'track_event']);
        add_action('wp_ajax_nopriv_slos_track_widget_event', [$this, 'track_event']);
    }
    ...
    public function enqueue_assets() {
        ...
        wp_localize_script('slos-accessibility-widget', 'slosWidget', [
