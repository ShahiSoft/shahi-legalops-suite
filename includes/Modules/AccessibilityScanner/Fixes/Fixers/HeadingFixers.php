...
class SkippedHeadingLevelFixer extends BaseFixer {
    public function get_id() { return 'skipped-heading-level'; }
    public function get_description() { return 'Fix skipped heading levels'; }
...
class HeadingNestingFixer extends BaseFixer {
    public function get_id() { return 'heading-nesting'; }
    public function get_description() { return 'Fix heading structure'; }
...
class HeadingLengthFixer extends BaseFixer {
    public function get_id() { return 'heading-length'; }
    public function get_description() { return 'Optimize heading length'; }
...
class HeadingUniquenessFixer extends BaseFixer {
    public function get_id() { return 'heading-uniqueness'; }
    public function get_description() { return 'Ensure unique headings'; }
...
class HeadingVisualFixer extends BaseFixer {
    public function get_id() { return 'heading-visual'; }
    public function get_description() { return 'Mark visually styled headings'; }
