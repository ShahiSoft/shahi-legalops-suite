...
class ModulesController {
    ...
    public function register_routes() {
        // List all modules
        register_rest_route(RestAPI::get_namespace(), '/modules', array(
        ...
        // Get single module
        register_rest_route(RestAPI::get_namespace(), '/modules/(?P<id>[a-zA-Z0-9_-]+)', array(
            'methods'             => \WP_REST_Server::READABLE,
        ...
        // Enable module
        register_rest_route(RestAPI::get_namespace(), '/modules/(?P<id>[a-zA-Z0-9_-]+)/enable', array(
        ...
        // Disable module
        register_rest_route(RestAPI::get_namespace(), '/modules/(?P<id>[a-zA-Z0-9_-]+)/disable', array(
            'methods'             => \WP_REST_Server::CREATABLE,
        ...
        register_rest_route(RestAPI::get_namespace(), '/modules/(?P<id>[a-zA-Z0-9_-]+)/settings', array(
