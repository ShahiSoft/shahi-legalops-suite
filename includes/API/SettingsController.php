...
class SettingsController {
    ...
    public function register_routes() {
        // Get all settings
        register_rest_route(RestAPI::get_namespace(), '/settings', array(
        ...
        // Export settings
        register_rest_route(RestAPI::get_namespace(), '/settings/export', array(
        ...
        // Import settings
        register_rest_route(RestAPI::get_namespace(), '/settings/import', array(
            'methods'             => \WP_REST_Server::CREATABLE,
