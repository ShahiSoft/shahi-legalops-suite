...
class AnalyticsController {
    ...
    public function register_routes() {
        // Get analytics stats
        register_rest_route(RestAPI::get_namespace(), '/analytics/stats', array(
        ...
        // Get events
        register_rest_route(RestAPI::get_namespace(), '/analytics/events', array(
            'methods'             => \WP_REST_Server::READABLE,
        ...
        // Track new event
        register_rest_route(RestAPI::get_namespace(), '/analytics/track', array(
    ...
    public function get_events($request) {
        ...
        // Get events
        $query = "SELECT * FROM $analytics_table WHERE $where_clause ORDER BY created_at DESC LIMIT %d OFFSET %d";
        $values[] = $limit;
        $values[] = $offset;
