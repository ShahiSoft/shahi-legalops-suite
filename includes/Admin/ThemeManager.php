...
class ThemeManager {
    ...
    public function __construct() {
        ...
        add_action('admin_enqueue_scripts', [$this, 'inject_theme_variables']);
        add_action('wp_ajax_shahi_switch_theme', [$this, 'ajax_switch_theme']);
    }
    ...
    public function ajax_switch_theme() {
        ...
        if (empty($theme_key)) {
            wp_send_json_error(['message' => 'Theme key is required']);
        }
